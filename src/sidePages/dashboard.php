                ...
                <div class="recent_section">
                    ...
                    <div class="recent_item_con">
                        <div class="recent_item">
                            <div class="flex recent_item_name_wrap">
                                <div class="recent_item_file_icon file_icon" data-file_type="image"></div>
                                <div class="recent_item_file_name text_field">Flex box cheat sheet.jpg</div>
                            </div>
                            <div class="recent_item_Modified_date text_field">Nov 21,2002</div>
                            <div class="recent_item_size text_field">2.5 MB</div>
                        </div>
                    </div>
                </div>
            </div>
